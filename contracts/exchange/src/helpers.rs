...
impl CwTemplateContract {
    ...
    /// Get Exchange Info
    pub fn get_exchange_info<Q, T, CQ>(&self, querier: &Q) -> StdResult<GetExchangeInfoResponse>
    where
        Q: Querier,
        T: Into<String>,
        CQ: CustomQuery,
    {
        let msg = QueryMsg::GetExchangeInfo {};
    ...
    /// Get Owner
    pub fn get_marker_account<Q, T, CQ>(&self, querier: &Q) -> StdResult<GetMarkerAccountResponse>
    where
        Q: Querier,
        T: Into<String>,
        CQ: CustomQuery,
    {
        ...
        .into();
        let res: GetMarkerAccountResponse = QuerierWrapper::<CQ>::new(querier).query(&query)?;
        Ok(res)
    }
}
